...
const EULA = () => {
  return (
    ...
    <div className="eula container mt-4">
      ...
      <p>
        hereinafter referred to as SOFTWARE - is offered to the purchaser/user hereinafter referred to as CUSTOMER on the following terms and conditions, which the Customer will be deemed to have accepted in full upon opening/using and installing the SOFTWARE.
      </p>
      <p>
      ...
      <h2>General</h2>
      <ul>
        <li>The LICENSOR is the owner of copyright and all other intellectual property rights in the SOFTWARE.</li>
        <li>The LICENSOR grants to the CUSTOMER, a non-exclusive license to use the SOFTWARE, upon the terms and conditions contained hereinafter.</li>
        <li>The CUSTOMER, by opening and installing this SOFTWARE, is deemed to have read, understood and agreed to be bound by the terms of this agreement. It is also agreed that this agreement is the complete and exclusive statement of agreement between the CUSTOMER and the LICENSOR.</li>
        <li>The license to use the SOFTWARE becomes valid only after full payment towards the same has been realised by the supplier of the SOFTWARE.</li>
        <li>The CUSTOMER will not decompile, disassemble or otherwise modify the SOFTWARE, except as provided for by this license.</li>
        <li>The CUSTOMER is solely responsible for determining the suitability of the SOFTWARE for the purpose it is intended to be used, before the purchase of the SOFTWARE. Once the CUSTOMER purchases the SOFTWARE, the LICENSOR will not accept return of SOFTWARE under any circumstances, whatsoever, and the payment once made will be non-refundable.</li>
        ...
        <li>The SOFTWARE is offered in various secondary editions based on features. Each edition is available in one or more different variants – e.g. Single-user, Multi-user. In case of Single-user, the CUSTOMER can install the SOFTWARE on a single Computer/Device only. In case of Multi-user, the CUSTOMER can install the SOFTWARE on a single Local Area Network (LAN).</li>
        <li>The INFINITY ERP comes with a Software Security Lock, which needs to be installed on the Server/Standalone Computer over LAN, where the SOFTWARE is to be used. The SOFTWARE will work only when a valid Software Security Lock is found installed at the Server/Standalone Computer.</li>
        <li>The CUSTOMER will take all reasonable precautions and measures to protect the SOFTWARE and related Items from unauthorized use, access, copying, modifications, reproduction, distribution or publication.</li>
        <li>Under no circumstances, the LICENSOR will replenish the License Information if the same is lost / misplaced / destroyed, either intentionally or accidentally, by the CUSTOMER. In such a case, a new copy of the SOFTWARE needs to be purchased by the CUSTOMER at full price, as prevailing in the market at that time.</li>
        <li>The price of the SOFTWARE is the license fee for use of the SOFTWARE only. All services like Installation, Training, Support, Document Designing etc. are chargeable extra.</li>
        <li>Updates, enhancements, bug-fixing, additions and improved versions of the SOFTWARE, along with a host of Value-Added Services (VAS), will be available to the CUSTOMER only if INFINITY ERP License Subscription (AMC) is active. One-Year AMC will be provided to the CUSTOMER on purchase of New License. The same can be renewed / extended for one more year upon payment of additional fee / price, as per the policy of the LICENSOR, as may be prevalent from time to time.</li>
        <li>The LICENSOR does not guarantee the compatibility of the SOFTWARE and / or Software License Service with future Operating Systems / Technologies.</li>
        <li>The LICENSOR will not take any responsibility for any kind of corruption of data at the CUSTOMER site due to media failure / power failure / hardware problem / virus infection or any other reason. At most, the LICENSOR can try to recover the data either fully or partially and the same will be chargeable.</li>
        <li>It is expressly agreed by the CUSTOMER that neither the manufacturer nor the supplier of the SOFTWARE will be liable for any loss or damage, whether direct, indirect, special, consequential and / or incidental, arising from the use or application of the SOFTWARE and related items.</li>
        <li>The Statutory Reports provided in the SOFTWARE are intended to provide the information / data to the CUSTOMER, which is required for fulfilling of various statutory obligations like depositing of tax, filing of tax returns etc. The LICENSOR does not guarantee, promise or claim accuracy, completeness or adequacy of the information provided and makes no claim that the Statutory Reports provided in the SOFTWARE will be accepted by the tax authorities as it is. The Licensor will not be responsible for any error / omission or delay in fulfilling of statutory obligations by the CUSTOMER. In case there is any change in statutory requirement, the LICENSOR will try to incorporate the same in the forthcoming releases of the SOFTWARE, but will be under no obligation to do so.</li>
        <li>The parties hereby agree that the courts at Raigarh (Chhattisgarh) alone will have the jurisdiction to entertain any proceedings in respect of anything arising under this agreement.</li>
      </ul>
      <h2>Limitations</h2>
      <p>Except as otherwise expressly provided under this License Agreement, CUSTOMER shall have no right, and CUSTOMER specifically agree not to:</p>
      <ul>
        <li>Utilize the SOFTWARE beyond the applicable Term;</li>
        <li>Transfer, assign or sublicense CUSTOMER’s license rights to any other person, and any such attempted transfer, assignment or sublicense shall be void;</li>
