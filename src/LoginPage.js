...
import logo from './assets/img/InfinityX.png';
import codeplayers from './assets/img/CodePlayers2.png';
        ...
        <div className="row pt-5">
          <div className="col-xl-7 col-lg-6 col-md-12">
            <div className="text-center pb-3">
              <img src={logo} alt="Infinity X" style={{ height: '96px' }} />
              ...
              <form onSubmit={handleLogin}>
                ...
                <div className="d-grid gap-2 col-12 mx-auto">
                  ...
                  <div className="text-center pb-2">
                    <img src={codeplayers} alt="CodePlayers" style={{ height: '48px' }} />
                  </div>
                </div>
              </form>
            </div>
